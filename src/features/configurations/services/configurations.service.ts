import type {
  ...
  export const configurationsService = {
    async getConfigurations(): Promise<Configurations> {
      // TODO: Substituir por chamada real: return apiClient.get('/configurations')
    ...
    async saveConfigurations(config: Configurations): Promise<void> {
      // TODO: Substituir por chamada real: return apiClient.put('/configurations', config)
      return new Promise((resolve) => {
    ...
    async testConnection(apiKeys: ExchangeApiKeys): Promise<{ success: boolean; message: string }> {
      // TODO: Substituir por chamada real: return apiClient.post('/configurations/test-connection', apiKeys)
      return new Promise((resolve) => {
        setTimeout(() => {
    ...
    async getAvailablePairs(): Promise<string[]> {
      // TODO: Substituir por chamada real: return apiClient.get('/exchange/pairs')
      return new Promise((resolve) => {
        setTimeout(() => {
          resolve([
