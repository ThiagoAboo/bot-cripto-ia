...
import { Key, Palette, Save, User } from 'lucide-react'
...
import { useChangePassword, useProfile, useUpdatePreferences, useUpdateProfile } from './hooks/useProfile'
...
export default function ProfilePage() {
  ...
  const handleSavePreferences = () => {
    updatePreferences({ theme: theme === 'dark' ? 'dark' : 'light' })
  }
    ...
    return (
      <div className="space-y-6 pb-8">
        <div>
          ...
          <p className="mt-1 text-gray-400">Carregando...</p>
        </div>
  ...
  return (
    <div className="space-y-6 pb-8">
      <div>
        <h1 className="text-2xl font-bold text-white">Perfil</h1>
        <p className="mt-1 text-gray-400">Gerencie suas informações e preferências</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end">
              <Button onClick={handleSavePreferences} disabled={isUpdatingPreferences} className="gap-2">
                <Save className="h-4 w-4" />
